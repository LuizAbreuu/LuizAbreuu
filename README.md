...
## 🧰 Frameworks: 
[![My Skills](https://skillicons.dev/icons?i=react,dotnet,bootstrap,express,jquery,nextjs)](https://skillicons.dev)

## 🗄️ Bancos de Dados: 
[![My Skills](https://skillicons.dev/icons?i=mysql,mongo,sqlserver)](https://skillicons.dev)

## ⚙️ Ferramentas:
[![My Skills](https://skillicons.dev/icons?i=git,github,visualstudio,docker,aws,azure,graphql,rabbitmq)](https://skillicons.dev)<br><br>
